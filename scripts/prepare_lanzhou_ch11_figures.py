#!/usr/bin/env python3
"""Prepare reproducible print/web variants for Lanzhou Chapter 11 figures."""
...
CONFIG_PATH = ROOT / "data/images/lanzhou/ch11-figures.config.json"
...
def main() -> int:
    ...
    for figure in config["figures"]:
        ...
        provenance = {
            ...
            "postprocess": (
                "Pillow sRGB conversion, centre-cropped 16:9 print/web variants, "
                "Lanczos resampling, JPEG quality 92; web quality 88"
            ),
            "output": {
            ...
            "rights": (
                "Original LazyTravel composition; external character and location "
                "imagery was used only as an unredistributed visual reference"
            ),
            "visual_qa": qa,
        }
