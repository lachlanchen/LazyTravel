#!/usr/bin/env python3
"""Prepare reproducible print/web variants and provenance for Hakone Chapter 9."""
...
CONFIG_PATH = ROOT / "data/images/hakone/ch09-figures.config.json"
...
def main() -> int:
    ...
    for figure in config["figures"]:
        ...
        provenance = {
            ...
            "postprocess": (
                "Pillow sRGB conversion, metadata-free width resize, bottom-anchored "
                "16:9 print/web crops, Lanczos resampling, JPEG quality 92; web quality 88"
            ),
            ...
            "rights": (
                "Original LazyTravel composition; external character references are "
                "hash-pinned and not redistributed"
            ),
            "visual_qa": qa,
        }
