...
def build_inputs(document: dict[str, Any], chapter_ids: list[str]) -> list[Path]:
    inputs = {
        ...
        ROOT / "scripts/build_hakone_itinerary_days_map.py",
        ROOT / "scripts/build_hakone_beyond_branch_map.py",
        ...
        ROOT / "scripts/prepare_hakone_ch10_figures.py",
        ROOT / "scripts/prepare_hakone_ch11_figures.py",
...
def main() -> int:
    ...
    if not args.skip_map:
        ...
        run([sys.executable, "scripts/build_hakone_itinerary_days_map.py"])
        run([sys.executable, "scripts/build_hakone_beyond_branch_map.py"])
    run(
        [
            sys.executable,
