...
| 5 | Lake Ashi southbound-choice map with boat and bus fallback | Togendai harbor decision; boat crossing; shrine forest approach; Lake Ashi wakasagi meal; Onshi Park and lakeshore | Let places and food carry the chapter. Make the route readable even when Fuji is absent, and avoid one impossible composite viewpoint. |
