...
class WebsiteBuildTests(unittest.TestCase):
    ...
    def test_static_renderer_has_no_external_runtime_dependency(self) -> None:
        ...
        self.assertIn("WAKASAGI · A LAKE MEAL", javascript)
        self.assertIn("LAKE ASHI · CHOOSE THE SOUTHBOUND STOP", javascript)
        self.assertNotIn('asset.id.replace(/^asset-/', javascript)
