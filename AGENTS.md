...
- Lanzhou at `china/cities/lanzhou` is the only next production destination.
  ...
  `books/china/cities/lanzhou/editorial/outline.md`. Chapters 1 through 5,
  through Read One Route Through Gansu Provincial Museum, are accepted. Chapter
  6, Eat by Lanzhou's Clock, is the only active production gate;
