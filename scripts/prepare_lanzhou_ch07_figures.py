#!/usr/bin/env python3
"""Prepare reproducible print/web variants and provenance for Lanzhou Chapter 7."""
...
CONFIG_PATH = ROOT / "data/images/lanzhou/ch07-figures.config.json"
...
def main() -> int:
    ...
    for figure in config["figures"]:
        ...
        provenance = {
            ...
            "rights": (
                "Original LazyTravel composition; external imagery was used only "
                "as an unredistributed visual reference"
            ),
            "visual_qa": qa,
        }
