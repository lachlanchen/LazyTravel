...
8. **Arrive and Move: Put Transfers Into the Route**  
   Airport, Xi'an North, Xi'an Station, metro, buses, taxis, walking, luggage,
   accessibility, payment, and current-data warnings. Every operational detail
   requires a dated official citation.

9. **Choose a Side of the City, Not a Star Count**  
   Stay areas by itinerary: inside the wall, South Gate, Qujiang/Yanta, North
   Station, and Lintong. Named hotels appear only after current verification;
   the durable advice is neighborhood-based.

10. **Two, Three, and Five Days With Room to Stop**  
    First visit, history-heavy, food-led, family, and reduced-mobility routes.
...
- Begin with concrete observation, then explain; do not open with rankings or
  claims of timeless grandeur.
- Name uncertainty and scholarly disagreement instead of smoothing it away.
- Avoid “must-see,” “hidden gem,” “where ancient meets modern,” and dynasty
  roll-calls without a spatial purpose.
- Chinese establishes local precision, Japanese is edited as independent
  travel prose, and English favors direct spatial explanation. None is a gloss
  of another language.
