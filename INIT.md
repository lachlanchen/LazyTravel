...
5. Continue only the next unfinished Hakone chapter. Chapters 1 through 7 are
   accepted; Chapter 8 is next. Update its fact ledger, aligned JSON, three
...
at `japan/prefectures/kanagawa/hakone`. Hakone Chapters 1 through 7 are accepted
and synced; Chapter 8 is next. Lanzhou follows the complete Hakone book; never
