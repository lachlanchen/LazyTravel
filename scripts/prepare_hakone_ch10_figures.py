#!/usr/bin/env python3
"""Prepare reproducible print/web variants and provenance for Hakone Chapter 10."""
...
CONFIG_PATH = ROOT / "data/images/hakone/ch10-figures.config.json"
...
def main() -> int:
    ...
    for source in [*config["guides"], *config.get("visual_references", [])]:
        ...
        record = {**path_record(path), "role": source["role"]}
    ...
    for figure in config["figures"]:
        ...
        with Image.open(raw_path) as opened:
            ...
            wide = center_crop(source, WIDE_SIZE)
            web = center_crop(source, WEB_SIZE)
        ...
        provenance = {
            ...
            "postprocess": (
                "Pillow sRGB conversion, metadata-free width resize, centered "
