...
5. Keep Xi'an, Hakone, and all 11 Lanzhou chapters closed. All three
   destinations are publicly published. Do not reopen a chapter without a
   demonstrated failure, and do not start another destination until the user
...
Current gate: Xi'an, Hakone, and Lanzhou are complete and publicly published.
Lanzhou's reproducible `216`-page repository and Nutstore pocket has SHA-256
`a6b70500bbe599b636786f4c5bd012c26fb8a3f2a5715909f729f1bc2e8a7dee`; Pages run
`32622242430` and an independent `123`-file deployed comparison pass. No later
destination is active, and two books must never enter production at once.
