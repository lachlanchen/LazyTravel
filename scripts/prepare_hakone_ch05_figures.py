#!/usr/bin/env python3
"""Prepare reproducible print/web variants and provenance for Hakone Chapter 5."""
...
CONFIG_PATH = ROOT / "data/images/hakone/ch05-figures.config.json"
...
def main() -> int:
    ...
    for figure in config["figures"]:
        ...
        provenance = {
            ...
            "output": {
                **path_record(base_path, include_dimensions=True),
                "color_space": "sRGB",
            },
            "variants": {
