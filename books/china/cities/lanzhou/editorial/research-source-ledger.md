...
| `LZH-HISTORY-2020` | `Sources/甘肃简史.pdf`; introduction pp. 5-6 on the Lanzhou-Hexi relationship, geography section beginning printed p. 3, sections on Qin/Han Jincheng, Sui/Tang administration, `陕甘分省及兰州的崛起` around printed p. 255, and the iron bridge around printed pp. 279-280 | SHA-256 `d4e621e7045c1671c74d7d87e5a271e8b8fe3aed0f9191f01f3e0e9ac98d7cdf`; text-layer extraction at ignored `build/research/lanzhou/source-extraction/gansu-brief-history/source.raw.txt` | Secondary geography and chronology for the Hexi Corridor, crossing, provincial administration, bridge, railway, and industry. Avoid turning historical corridor geography into a modern itinerary or collapsing changing administrative units into one continuous city. Reconcile exact bridge dimensions, cost, and dates with local records before using them. |
...
All web sources below were opened or rechecked from `2026-08-21` through
`2026-08-23`. A check date
...
| `CR-12306-BOARDING-2026` | China Railway 12306, boarding and ticket-change guidance | <https://kyfw.12306.cn/otn/gonggao/windowEndorse.html> | Rechecked `2026-08-23`; confirms that station ticket and boarding processes stop before departure and that internal station distance requires time. It does not establish one universal cutoff, arrival margin, entrance, or gate. |
| `CR-12306-PRIORITY` | China Railway 12306, priority-passenger service | <https://kyfw.12306.cn/otn/view/icentre_qxyyInfo.html> | Rechecked `2026-08-23`; currently asks for normal online requests at least six hours before departure, directs requests inside six hours to the station no later than 60 minutes before departure, and treats transfer legs separately. Eligibility, acceptance, service scope, evidence, and timing remain live checks; the service label never proves a step-free journey. |
| `LZH-RAIL-SUMMER-2026` | Gansu Belt and Road portal, China Railway Lanzhou Bureau 2026 summer operations | <https://ydyl.gansu.gov.cn/gsydyl/gswt/sslt/202607/t20260702_37846.html> | Dated evidence that capacity and bookable patterns change with seasonal demand across Hexi Corridor and other Gansu directions. Named temporary or strengthened services are not copied into the guide and do not establish another day's timetable, fare, seat, or departure station. |
| `LZH-ONWARD-GATES-MAP-DATA` | Original LazyTravel onward-gate decision diagram | `data/maps/lanzhou/lanzhou-onward-gates.config.json` | Reproducible work-back branches for Lanzhou West, Lanzhou Station, and T3. The valid booking selects one branch. Arrows show planning order only and provide no railway, road, metro, distance, duration, fare, or connection claim. |
