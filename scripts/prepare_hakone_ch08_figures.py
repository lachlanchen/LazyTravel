#!/usr/bin/env python3
"""Prepare reproducible print/web variants and provenance for Hakone Chapter 8."""
...
CONFIG_PATH = ROOT / "data/images/hakone/ch08-figures.config.json"
...
def main() -> int:
    ...
    for source in [*config["guides"], *config.get("visual_references", [])]:
    ...
    for figure in config["figures"]:
        ...
        provenance = {
            ...
            "rights": "Original LazyTravel composition; external character and product references are hash-pinned and not redistributed",
            "visual_qa": qa,
        }
