...
5. Continue only the next unfinished Hakone chapter. Chapters 1 through 4 are
   accepted; Chapter 5 is next. Update its fact ledger, aligned JSON, three language
...
at `japan/prefectures/kanagawa/hakone`. Hakone Chapters 1 through 4 are accepted,
published, and synced; Chapter 5 is next. Lanzhou follows the complete Hakone
